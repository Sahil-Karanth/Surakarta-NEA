...
class Graphical_UI(UI):
    ...
    def __make_piece_button(self, piece_type, key, visible=False):
        ...
        return sg.Button("", image_filename=f"{piece_type}_counter.png", pad=self.PIECE_BUTTON_PAD, visible=visible, key=key, button_color=(sg.theme_background_color(), sg.theme_background_color()), border_width=0)
